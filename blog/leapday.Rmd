...
For CSS, I'm using vanilla CSS, which is a very cool [open source](https://vanillacss.com/) open-source style sheet that I really liked the look of. Though I did adjust some of the colors to give my site more flavor.
